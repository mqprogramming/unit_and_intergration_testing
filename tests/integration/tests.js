...
describe('calculator functionality', function() {
  ...
  it('should have operations that update the display', function() {
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
  ...
  it('should have chainable operations', function() {
    running_total = element(by.css('#running_total'))
  ...
  it('should work with large numbers', function() {
    ...
    element(by.css('#number9')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('57399999426')
  })
  ...
  it('should throw error dividing by 0', function() {
    running_total = element(by.css('#running_total'))
    element(by.css('#number7')).click();
    element(by.css('#operator_divide')).click();
